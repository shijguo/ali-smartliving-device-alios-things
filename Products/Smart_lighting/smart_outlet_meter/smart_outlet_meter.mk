...
ifeq ($(CONFIG_ENERGY_METER), ENABLE)
$(NAME)_SOURCES += energy_meter_hal.c
$(NAME)_PREBUILT_LIBRARY := lib/$(HOST_ARCH)/libmeter.a
endif
...
CONFIG_SYSINFO_APP_VERSION = app-1.6.0-${CONFIG_COMPILE_DATE}
...
ifeq ($(CONFIG_ENERGY_METER), ENABLE)
GLOBAL_CFLAGS += -DENERGY_METER_ENABLE
endif
