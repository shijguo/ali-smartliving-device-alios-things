...
#define MY_PRINTF(...) do{ HAL_Printf("#####################\r\n");HAL_Printf(__VA_ARGS__); HAL_Printf("\r\n#####################\r\n");} while(0)
//默认通断电配置
#if(DEF_POWER_STATUS_1 == 0)
#define REBOOT_STATE LAST_STATE
#elif(DEF_POWER_STATUS_1 == 1)
#define REBOOT_STATE POWER_ON
#elif(DEF_POWER_STATUS_1 == 2)
#define REBOOT_STATE POWER_OFF
#endif
